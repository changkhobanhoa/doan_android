...
public class AddHouse extends AppCompatActivity {
    ...
    public void dialogSelectThanhPho() {
        ...
        Button btnCancel = dialog.findViewById(R.id.btnCancel);
        androidx.appcompat.widget.SearchView  searchView_service = dialog.findViewById(R.id.searchView_thanhpho);
        ...
        searchView_service.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                adapterAddHouse.getFilter().filter(query);
                Log.e("Loi",query);
                return false;
            }
            ...
            public boolean onQueryTextChange(String newText) {
                adapterAddHouse.getFilter().filter(newText);
                return false;
            }
        });
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(AddHouse.this,RecyclerView.VERTICAL,false);
