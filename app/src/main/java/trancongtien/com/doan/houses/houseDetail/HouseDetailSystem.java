...
import trancongtien.com.doan.houses.houseDetail.rooms.addRoom.AddRoom;
import trancongtien.com.doan.houses.updateHouse.UpdateHouse;
import trancongtien.com.doan.model.*;
    ...
    private void init() {
        ...
        ll_danhSachPhong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txt_bgColor1.setBackgroundColor(Color.parseColor("#5677fc"));
        ...
        ll_chiTietNha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txt_bgColor2.setBackgroundColor(Color.parseColor("#5677fc"));
