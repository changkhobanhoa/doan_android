package trancongtien.com.doan.houses.updateHouse;
...
import trancongtien.com.doan.houses.addHouse.AdapterSelectCityState;
import trancongtien.com.doan.houses.addHouse.AdapterSelectDistrict;
import trancongtien.com.doan.houses.addHouse.ListTinhThanhPhoVN;
...
public class UpdateHouse extends AppCompatActivity {
    ...
    public void dialogSelectQuanHuyen() {
        ...
        }else if(strThanhPho.equals("Đà Nẵng")){
            adapterAddHouse = new AdapterSelectDistrict(this, ListTinhThanhPhoVN.listQuanHuyen_DaNang, dialog, txt_selectQuanHuyen);
        }
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(UpdateHouse.this,RecyclerView.VERTICAL,false);
        rcv_stateCitySelection.setLayoutManager(linearLayoutManager);
        rcv_stateCitySelection.setAdapter(adapterAddHouse);
