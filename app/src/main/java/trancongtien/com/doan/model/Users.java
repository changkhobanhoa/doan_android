package trancongtien.com.doan.model;
public class Users {
    private String id;
    private String name, phoneNumber, email, password, accountType,typeAcc,
            premiumPackageName;
    ...
    public Users(String id, String name, String phoneNumber, String email, String password, String accountType, String typeAcc, String premiumPackageName) {
        this.id = id;
        this.name = name;
        this.phoneNumber = phoneNumber;
        this.email = email;
